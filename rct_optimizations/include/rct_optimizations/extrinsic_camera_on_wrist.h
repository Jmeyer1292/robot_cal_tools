...
struct ExtrinsicCameraOnWristResult
{
  ...
  /**
   * @brief Covariance matrix of wrist-to-camera transform
   */
  Eigen::MatrixXd covariance_wrist_to_camera;

  Eigen::MatrixXd covariance_base_to_target;

  Eigen::MatrixXd covariance_w2c_vs_b2t;
};
