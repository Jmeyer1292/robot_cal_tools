...
//rct_optimizations::test::CorrGen::CorrGen(Eigen::Isometry3d focus, rct_optimizations::test::Target target): focus_(focus)
//{
//  setTarget(Target);
//}

//void rct_optimizations::test::CorrGen::setTarget(rct_optimizations::test::Target target)
//{
//  target_ = Target;
//}

//void rct_optimizations::test::CorrGen::setFocus()

////store isometry vector as private variable as it is an intermediate output (no need to return half baked solution)
//void rct_optimizations::test::CorrGen::genHemispherePose(double r,
//                                int theta_cnt,
//                                int phi_cnt
//                                )
//{
...
//      //camera may not need to be isometry since we only use the translation portion
//      //x is 'up' in target frame (confirm)
//      Eigen::Isometry3d camera_oriented = rct_optimizations::test::lookat(camera.translation(), focus_.translation(), Eigen::Vector3d(1, 0, 0));

//      //this vector is still in target spatial coordinates
//      camera_positions_.push_back(camera_oriented);
//      //for world frame need target * position
//      // camera_positions.push_back(focus_ * camera_oriented)?
//    }
//  }
...
//void rct_optimizations::test::CorrGen::genConicalPose(int observations,
//                                                      double r,
//                                                      double h
//                                                      )
...
//  {
//    Eigen::Isometry3d camera_pose = Eigen::Isometry3d::Identity();
//    camera_pose.translation() = focus_.translation();

//    //preserving target spatial coordinate frame:
//    camera_pose.translate(Eigen::Vector3d{r * cos(i*dt), r*sin(i*dt), h});

//    //change orientation to look at target
//    Eigen::Isometry3d camera_oriented = rct_optimizations::test::lookat( camera_pose.translation(), focus_.translation(), Eigen::Vector3d(1, 0, 0));
...
//void rct_optimizations::test::CorrGen::clearPoses()
//{
//  std::vector<Eigen::Isometry3d> clean_pose_vector;
//  camera_positions_ = clean_pose_vector;
//}
