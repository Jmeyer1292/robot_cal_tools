 ...
 */
std::vector<Eigen::Isometry3d> genHemispherePose(Eigen::Isometry3d target_pose, double r, int theta_cnt, int phi_cnt);
/**
 ...
 * @return A vector of camera positions & orientations
 */
std::vector<Eigen::Isometry3d> genConicalPose(Eigen::Isometry3d target_pose, int observations, double r, double h);
 ...
 * @return A vector of camera positions & orientations
 */
std::vector<Eigen::Isometry3d> genGridPose(Eigen::Isometry3d target_pose, int grid_side, double spacing, double h);
}  // namespace test
}  // namespace rct_optimizations
#endif  // POSE_GEN
