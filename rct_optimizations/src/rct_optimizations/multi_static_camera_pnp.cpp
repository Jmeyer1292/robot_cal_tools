...
rct_optimizations::MultiStaticCameraPnPResult
rct_optimizations::optimize(const rct_optimizations::MultiStaticCameraPnPProblem& params)
{
  ...
  MultiStaticCameraPnPResult result;
