...
KinObservation2D3D::Set loadMeasurements(const std::string& filename)
{
  ...
  try
  {
    ...
    {
      KinObservation2D3D measurement;
...
void test(const DHChain& initial_camera_chain, const DHChain& initial_target_chain,
          const KinematicCalibrationResult& result, const KinObservation2D3D::Set& measurements)
{
...
int main(int argc, char** argv)
{
  ...
  KinObservation2D3D::Set measurements = loadMeasurements(argv[1]);
