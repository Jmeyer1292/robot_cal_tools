...
{
  ros::init(argc, argv, "charuco_calib_test");
  ros::NodeHandle pnh("~");
  ...
  int squaresX = 5;
  int squaresY = 7;
  double squareLength = 0.036195; // Measurement of chessboard square length
  double markerLength = 0.018256; // Measurement of Aruco marker length
  ...
  for (std::size_t i = 0; i < data_set.images.size(); ++i)
  {
    ...
    obs.correspondence_set = target.createCorrespondences(maybe_obs);
